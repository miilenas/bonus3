<?php 
    class Prijava {
        ...
        public static getById($id, mysqli $conn){
        ...
        public static function update(Prijava $prijava, mysqli $conn) {
            $query_str = "UPDATE prijave SET predmet = '$prijava->predmet', 
            katedra = '$prijava->katedra', sala = '$prijava->sala', 
            datum = '$prijava->datum' WHERE id = $prijava->id";
